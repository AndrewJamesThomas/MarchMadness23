...
# Read data
regresults <- read.csv("data\\mens-march-mania-2022\\MDataFiles_Stage2\\MRegularSeasonDetailedResults.csv")
results <- read.csv("data\\mens-march-mania-2022\\MDataFiles_Stage2\\MNCAATourneyDetailedResults.csv")
sub <- read.csv("data\\mens-march-mania-2022\\MDataFiles_Stage2\\MSampleSubmissionStage2.csv")
seeds <- read.csv("data\\mens-march-mania-2022\\MDataFiles_Stage2\\MNCAATourneySeeds.csv")
...
# save the data
write.csv(select(Z, ID, Pred), "data\\WElo_Predictions_stage1.csv", row.names = FALSE)
write.csv(select(Z, ID, Pred), "data\\WElo_Predictions_stage2.csv", row.names = FALSE)
